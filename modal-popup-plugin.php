...
add_action('wp_footer', function() {
    ...
    if ($modal) {
        ...
        if ($pop_add_video && $popup_video) {
            $popup_video_content .= '<div class="pop-video">' . $popup_video . '</div>' ;
        }
    ...
    <div id="custom-modal" class="custom-modal">
        <div class="custom-modal-content modal-width-<?php echo $modal_width ; ?> <?php echo $modal_add_image ? 'with-image' : ''; ?> <?php echo $pop_add_video ? 'with-video' : ''; ?>">
